...
###### Create a setup file that contains all the packages you’ve installed
...
###### Creating a setup file in conda
...
###### Deactivating and cleaning up environments
